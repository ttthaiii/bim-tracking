  ...
  return (
    <PageLayout>
      <div className="space-y-6">
        <h1 className="text-3xl font-bold text-gray-800">Document Tracking Dashboard</h1>
        
        {/* Document Status Overview */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Document Status Overview</h2>
          <DocumentStatusChart />
        </div>
